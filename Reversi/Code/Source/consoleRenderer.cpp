...
void ConsoleRenderer::AddDrawInterface(ConsoleDrawInterface* in_pAddRender)
{
...
void ConsoleRenderer::RemoveDrawInterface(ConsoleDrawInterface* in_pRemoveRender)
{
