...
/// ※全角文字は使えない！.
/// </summary>
class ConsoleRenderer : public ConsoleRenderingInterface
{
public:
	/// <summary>
	/// セットアップデータ.
	...
	/// 描画インターフェイスの登録.
	/// </summary>
	void AddDrawInterface(ConsoleDrawInterface* in_pAddRender) override final;

	/// <summary>
	/// 描画インターフェイスの解除.
	/// </summary>
	void RemoveDrawInterface(ConsoleDrawInterface* in_pRemoveRender) override final;
...
private:
	...
	std::vector<ConsoleDrawInterface*> _draws;
