...
extern	ULONGLONG	ConvSysPerformanceCountToSeconds(		ULONGLONG Max ) ;				// OSが提供する高精度カウンタの値を秒の値に変換する
extern	ULONGLONG	ConvSysPerformanceCountToMilliSeconds(	ULONGLONG Max ) ;				// OSが提供する高精度カウンタの値をミリ秒の値に変換する
extern	ULONGLONG	ConvSysPerformanceCountToMicroSeconds(	ULONGLONG Max ) ;				// OSが提供する高精度カウンタの値をマイクロ秒の値に変換する
extern	ULONGLONG	ConvSysPerformanceCountToNanoSeconds(	ULONGLONG Max ) ;				// OSが提供する高精度カウンタの値をナノ秒の値に変換する
