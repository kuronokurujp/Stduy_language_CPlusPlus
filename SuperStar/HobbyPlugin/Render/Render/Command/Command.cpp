...
namespace Render
{
    void CreateCmd2DTextDraw(const Core::Common::Handle& in_rViewHandle,
                             ...
                             const Core::Math::Rect2::EAnchor in_eAnchor)
    {
        ...
        Command cmd;
        {
            cmd.uType = CMD_TYPE_2D_TEXT_DRAW;
    ...
    void CreateCmd2DRectDraw(const Core::Common::Handle& in_rViewHandle,
                             const Core::Math::Rect2& in_rRect, const Color& in_rColor)
    {
        ...
        Command cmd;
        {
            cmd.uType              = CMD_TYPE_2D_RECT_DRAW;
    ...
    void CreateCmd2DPointDraw(const Core::Common::Handle& in_rViewHandle,
                              const Core::Math::Vector2& in_rPos, const Color& in_rColor)
    {
        ...
        Command cmd;
        {
            cmd.uType                = CMD_TYPE_2D_POINT_DRAW;
