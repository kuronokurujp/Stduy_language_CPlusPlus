...
namespace Core
{
    namespace Common
    {
        ...
        public:
            ...
            FixStringBase& operator= (const Char* in_pStr) { this->_Copy(in_pStr, this->_size); return *this; }
            FixStringBase& operator= (const FixStringBase &r) { this->_Copy(r.Str(), this->_size); return *this; }

            FixStringBase& operator+=(Char c) { this->_Add(c); return *this; }
            FixStringBase& operator+=(const Char* in_pStr) { this->_Add(in_pStr); return *this; }
            FixStringBase& operator+=(const FixStringBase &r) { this->_Add(r.Str()); return *this; }
        ...
        public:
           ...
           // FixString(const Char* in_pStr) : FixStringBase(_fixBuff, SIZE) { FixStringBase::operator=(in_pStr); }
            FixString(const Char* in_pStr) : FixStringBase(_fixBuff, SIZE) { this->_Copy(in_pStr, E_STR_LEN(in_pStr)); }
            ...
            FixString<SIZE>& operator= (const Char* in_pStr) { this->_Copy(in_pStr, E_STR_LEN(in_pStr)); return *this; }
            FixString<SIZE>& operator=(const FixString<SIZE> &r) { this->_Copy(r._fixBuff, E_STR_LEN(r._fixBuff)); return *this; }
            /*
            {
