...
namespace Sound
{
    ...
    bool AudioSystem::Initialize()
    {
        ...
        {
            result =
                this->pSystem->initialize(512, FMOD_STUDIO_INIT_NORMAL, FMOD_INIT_NORMAL, nullptr);
    ...
    void AudioSystem::LoadBank(const std::string& in_rName)
    {
        ...
        FMOD_RESULT result =
            this->pSystem->loadBankFile(in_rName.c_str(), FMOD_STUDIO_LOAD_BANK_NORMAL, &pBank);
        ...
        pBank->getEventList(bankEvents.data(), numEvents, &numEvents);
