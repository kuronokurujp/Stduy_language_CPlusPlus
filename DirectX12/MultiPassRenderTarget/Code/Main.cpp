...
int main(int argc, const char* argv[])
{
    ...
    // DirectX12の環境作成
    auto result = DirectX12::CreateContext(context);
    ...
    do {
        ...
        while (lag_s_time >= fixed_framerate_s_time)
        {
            ...
            // ゲーム更新
            game_ctrl.Tick((lag_s_time - fixed_framerate_s_time) + fixed_framerate_s_time);
    ...
    DirectX12::DeleteSystem(context);

    DirectX12::DeleteContext(context);
