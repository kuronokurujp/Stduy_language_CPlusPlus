...
namespace DirectX12
{
    ...
    /// <returns></returns>
    extern const HRESULT CreateEnvironment(std::shared_ptr<Context> in_p_context);
    ...
    extern void Delete(std::shared_ptr<Context> in_p_context);
    ...
    /// <returns></returns>
    extern const size_t GetAdapterdx(std::shared_ptr<Context> in_p_context, const std::wstring in_adapter_name);
